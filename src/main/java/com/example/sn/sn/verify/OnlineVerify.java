...
import static com.example.sn.sn.verify.JWTKt.JWT_TEST;
...
public class OnlineVerify {
    ...
    // and add it here.
    private static final String API_KEY = "AIzaSyCqc1_-btSSt0vHQXVSeJNAAD83ERrWJY4";
...
//        }
//        process(args[0]);
        process(JWT_TEST.replace(System.getProperty("line.separator"), ""));
        process(JWT_TEST.replace(System.getProperty("line.separator"), ""));
        process(JWT_TEST.replace(System.getProperty("line.separator"), ""));
        process(JWT_TEST.replace(System.getProperty("line.separator"), ""));
        process(JWT_TEST.replace(System.getProperty("line.separator"), ""));
